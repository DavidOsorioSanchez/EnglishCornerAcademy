export default function Soluciones(){
    return(
        <section className="w-full flex flex-col items-center gap-10 ">
            ...
            <div className="flex flex-nowrap shrink justify-around items-center gap-10 w-full">
                <div className="max-w-96 p-6 flex flex-col gap-2 rounded-md bg-mywhite/5">
                ...
                <div className="max-w-96 px-6 flex flex-col gap-2 rounded-md py-8 bg-mywhite/5">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-12 bg-blue-500/90 rounded-full p-2">
