    ...
    return(
        <section id={PricesUrl} className="w-full flex flex-col items-center gap-10 ">
            ...
            <div className="flex flex-col gap-10 w-full items-center">
                ...
                <div className="flex flex-col bg-mywhite/0 p-2 rounded-lg gap-1 min-[795px]:flex-row min-[795px]:bg-mywhite/5">
                    <div className="relative max-w-96 w-screen flex flex-col gap-2 rounded-md  bg-mywhite/15 min-[795px]:rounded-l-md min-[795px]:rounded-r-none">
                        {planIndividual ?(
                        ...
                        <div className="my-5 mx-4">
                            ...
                            <p className="font-semibold text-mywhite/85">
                                {planIndividual ? 
                                    <p className="lg">{precioIndividualClasePorHora}<span className="!text-xs font-normal text-mywhite/50">.000</span> /Clase</p> 
                                    : 
                                    <p>{precioGrupoClasePorHora}<span className="!text-xs font-normal text-mywhite/50">.000</span> /Clase</p>
                                }
                            </p>
                        </div>
                        
                    </div>
                    <div className="relative max-w-96 w-screen flex flex-col gap-2 rounded-md bg-mywhite/15 min-[795px]:rounded-l-none min-[795px]:rounded-r-md">
                        <div className="absolute top-o right-0 text-xs bg-blue-500 p-0.5 rounded-bl-md rounded-tr-md "> Promocion</div>
                        <div className="my-5 mx-4">
                            ...
                            <p className="font-normal text-mywhite/85">
                                {!planIndividual ? 
                                    <p className="lg">{precioIndividualPlanAfiliadosMensuales}<span className="!text-xs font-normal text-mywhite/50">.000</span> /Clase</p>
                                        : 
                                    <p>{precioGrupoPlanAfiliadosMensuales}<span className="!text-xs font-normal text-mywhite/50">.000</span> /Clase</p>
                                }
                            </p>
                        </div>
                    </div>
