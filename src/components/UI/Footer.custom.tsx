...
export default function FooterCustom() {
    return (
        <footer className="relative min-h-24 h-auto items-end  bg-linear-to-r from-cyan-500 to-blue-500 text-mywhite">
            <BookEffect />
            <div className="absolute -bottom-5 w-full h-full flex justify-around items-center">
                <p>© 2023 English Corner Academy</p>
